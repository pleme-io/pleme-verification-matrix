//!GENERATED by tatara-rust-derive::VerificationMatrixSpec.
//!Do not hand-edit; regenerate from the (defverification-matrix …) source.
//!
//!Two declarative test macros realizing the CLOSED-LOOP
//!MASS-SYNTHESIS verification-matrix-as-forcing-function rule.
